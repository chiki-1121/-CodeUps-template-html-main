    ...
    <div class="p-news__items">
      ...
      <div class="p-news__item p-news-content">
        <div class="p-news-content__meta">
          <time datetime="2023-07-23" class="p-news-content__date">2023.7.23</time>
        ...
        <div class="swiper js-works-swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide p-works__img">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/works_1.jpg" alt="">
            </div>
            <div class="swiper-slide p-works__img">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/service_1.jpg" alt="">
            </div>
            <div class="swiper-slide p-works__img">
              <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/service_2.jpg" alt="">
            </div>
          </div>
        </div>

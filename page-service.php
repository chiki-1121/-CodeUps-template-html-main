        ...
        <div class="p-page-service__items">
            ...
            <div class="p-page-service__item">
                <div class="p-page-service__image">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/service_1.jpg" alt="Webサイト制作の画像">
                </div>
                <div class="p-page-service__text-block">
                    <h2 class="p-page-service__title">Webサイト制作</h2>
                    <div class="p-page-service__text">新規サイトはもちろん、サイトリニューアルやランディングページ制作も承っております。<br>
            ...
            <div class="p-page-service__item">
                <div class="p-page-service__image">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/service_2.jpg" alt="Webサイト運用の画像">
                </div>
                <div class="p-page-service__text-block">
                    <h2 class="p-page-service__title">Webサイト運用</h2>
                    <div class="p-page-service__text">サイトの更新作業や独自のアクセス解析に基づいたサイト改善のご提案が可能です。<br>
            ...
            <div class="p-page-service__item">
                <div class="p-page-service__image">
                    <img src="<?php echo get_template_directory_uri() ?>/dist/assets/images/common/service_3.jpg" alt="アプリ開発の画像">
                </div>
                <div class="p-page-service__text-block">
                    <h2 class="p-page-service__title">アプリ開発</h2>
                    <div class="p-page-service__text">
